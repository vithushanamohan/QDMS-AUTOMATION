...
// (+0)======================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					...
					System.out.println("Testing " + WebPageName + ": " + WebElementName
							+ ": Common - Visiblity - expected:-" + ExpectedProperty + " actual:- " + null);
				}
			}
			DoTest = ExpectedProperty = "";
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Common - Enability ", ExpectedProperty,
							"NO ELEMENT");
					System.out.println("Testing " + WebPageName + ": " + WebElementName
							+ ": Common - Enability - expected:-" + ExpectedProperty + " actual:- " + null);
				}
			}
			DoTest = ExpectedProperty = "";
...
//Check JS - Hidden (+2)======================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": JS - Hidden ", ExpectedProperty,
							"NO ELEMENT");
					System.out.println("Testing " + WebPageName + ": " + WebElementName + ": JS - Hidden  - expected:-"
							+ ExpectedProperty + " actual:- " + null);
				}
			}
			DoTest = ExpectedProperty = "";
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": JS - Disabled ", ExpectedProperty,
							"NO ELEMENT");
					System.out.println("Testing " + WebPageName + ": " + WebElementName
							+ ": JS - Disabled  - expected:-" + ExpectedProperty + " actual:- " + null);
				}
			}
			DoTest = ExpectedProperty = "";
...
//Check Size (+4)======================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Size ", ExpectedProperty, "NO ELEMENT");
...
//Position (+5)======================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Position ", ExpectedProperty, "NO ELEMENT");
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Background - color ", ExpectedProperty,
							"NO ELEMENT");
					System.out.println("Testing " + WebPageName + ": " + WebElementName
							+ ": Background - color  - expected:-" + ExpectedProperty + " actual:- " + null);
				}
			}
			DoTest = ExpectedProperty = "";
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Border - color ", ExpectedProperty,
							"NO ELEMENT");
					System.out.println("Testing " + WebPageName + ": " + WebElementName
							+ ": Border - color  - expected:-" + ExpectedProperty + " actual:- " + null);
				}
			}
			DoTest = ExpectedProperty = "";
...
//Font - Type (+9)======================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Font-Type ", ExpectedProperty, "NO ELEMENT");
					System.out.println("Testing " + WebPageName + ": " + WebElementName
							+ ": Font-Type - color  - expected:-" + ExpectedProperty + " actual:- " + null);
				}
			}
			DoTest = ExpectedProperty = "";
...
//Font - Size (+10)======================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Font-Size ", ExpectedProperty, "NO ELEMENT");
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Text (spelling) ", ExpectedProperty,
							"NO ELEMENT");
					System.out.println("Testing " + WebPageName + ": " + WebElementName
							+ ": Text (spelling) - expected:-" + ExpectedProperty + " actual:- " + null);
				}
			}
			DoTest = ExpectedProperty = "";
...
//Box Shadow (+12)==============================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Box Shadow ", ExpectedProperty,
							"NO ELEMENT AVAIALABLE");
...
//Padding (+13)==============================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Padding ", ExpectedProperty,
							"NO ELEMENT AVAIALABLE");
...
//Cursor (+14)==============================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null")) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Cursor ", ExpectedProperty,
							"NO ELEMENT AVAIALABLE");
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": JS - Disabled ", ExpectedProperty,
							ActualProperty);
					System.out.println("Testing " + WebPageName + ": " + WebElementName
							+ ": JS - Disabled  - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
				}
			}
			DoTest = ExpectedProperty = ActualProperty = "";
...
//Position (+5)======================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Position ", ExpectedProperty,
							ActualProperty);
					System.out.println("Testing " + WebPageName + ": " + WebElementName + ": Position  - expected:-"
							+ ExpectedProperty + " actual:- " + ActualProperty);
				}
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Border - color ", ExpectedProperty,
							ActualProperty);
					System.out.println("Testing " + WebPageName + ": " + WebElementName
							+ ": Border - color  - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
				}
			}
			DoTest = ExpectedProperty = ActualProperty = "";
...
//Font - Type (+9)======================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Font-Type ", ExpectedProperty,
							ActualProperty);
					System.out.println("Testing " + WebPageName + ": " + WebElementName
...
//Font - Size (+10)======================================================================
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
					TestCasePrint(WebPageName + ": " + WebElementName + ": Font-Size ", ExpectedProperty,
							ActualProperty);
					System.out.println("Testing " + WebPageName + ": " + WebElementName + ": Font-Size - expected:-"
							+ ExpectedProperty + " actual:- " + ActualProperty);
				}
			...
			if (DoTest.equals("true") || DoTest.equals("")) {
				if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals("null")
					...
					TestCasePrint(WebPageName + ": " + WebElementName + ": Text (spelling) ", ExpectedProperty,
							ActualProperty);
					System.out.println("Testing " + WebPageName + ": " + WebElementName
							+ ": Text (spelling) - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
				}
			}
			DoTest = ExpectedProperty = ActualProperty = "";
...
//
	...
	public static int getLastRowNum(String iexcelPath, String ipageName, String itestCaseID) {
		String excelPath = iexcelPath;
		String pageName = ipageName;
		String testCaseID = itestCaseID;
	...
	public static int getFirstRowNum(String iexcelPath, String ipageName, String itestCaseID) {
		String excelPath = iexcelPath;
		String pageName = ipageName;
		String testCaseID = itestCaseID;
		...
		try {
			...
			for (int i = 0; i <= last; i++) {
				...
				if (values.contentEquals(testCaseID + "-01")) {
					lastRowNum = i;
					break;
				}
	...
	public static void ExcelSheetWrite(String location, String sheetname, int rownum, int columnnum,
			String printstatus) {
		/**
		 * 
		 * This method is used to write a string value to an Excel file at a specified
	...
	public static String ExcelSheetValue(String location, String sheetname, int rownum, int columnnum) {
		/**
		 * 
		 * This method retrieves the cell value at a specified location in an Excel
		 * workbook.
